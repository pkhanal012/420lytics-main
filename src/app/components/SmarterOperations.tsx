    ...
    >
      <div className="flex items-start justify-left mb-3 sm:mb-6 lg:mb-12 relative">
        <div className="relative transform hover:scale-110 transition-transform duration-300">
          <div 
            className={`absolute inset-0 bg-[#E8F8F0] rounded-full scale-0 
          ...
          <Image
            ...
            className={`relative z-10 w-6 h-6 sm:w-10 sm:h-10 lg:w-12 lg:h-12
                      ${isVisible ? 'animate-bounce' : ''} filter-green`}
            style={{ 
  ...
  return (
    ...
    >
      <div className="container mx-auto px-3 sm:px-6 lg:px-8">
        ...
        >
          <span 
            className={`inline-block px-2 sm:px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs sm:text-sm font-medium mb-2 sm:mb-3
