...
export default function PoweredBy() {
  ...
  return (
    ...
    >
      ...
      {/* Outer glow ring */}
      <div className={`absolute -inset-0.5 rounded-lg bg-gradient-to-r from-blue-500/0 via-blue-500/30 to-blue-500/20 opacity-0 blur-md transition-opacity duration-700 ${isGlowing ? 'opacity-100' : 'opacity-0'}`} />
