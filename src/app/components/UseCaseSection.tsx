    ...
    >
      ...
      <div className="flex flex-col md:flex-row flex-grow">
        ...
        <div className="md:w-2/5 p-4 sm:p-6 md:pt-8 md:pb-8 md:pl-8 md:pr-4">
          <div className="inline-block px-3 sm:px-4 py-1.5 sm:py-2 bg-green-600 rounded-md text-sm sm:text-base font-medium mb-3 sm:mb-4">
            Problem
          </div>
        ...
        <div className="md:w-3/5 p-4 sm:p-6 md:pt-8 md:pb-8 md:pr-8 md:pl-4">
          <div className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 bg-green-600 bg-opacity-40 rounded-md text-xs sm:text-sm font-medium mb-3 sm:mb-4">
            <BrandName /> Solves It:
          </div>
          ...
          <ul className="space-y-2 sm:space-y-3">
            {solutionPoints.map((point, idx) => (
              <li key={idx} className="flex items-start">
                <div className="flex-shrink-0 w-4 h-4 sm:w-5 sm:h-5 bg-green-500 rounded-full flex items-center justify-center mt-0.5 mr-2">
...
export default function UseCaseSection() {
  ...
  const useCases = [
    ...
    },
    {
      ...
      solutionPoints: [
        "Upload raw Excel or CSV files — 420lytics automatically structures, validates, and transforms the data.",
        ...
        <div className="pt-20 sm:pt-24 lg:pt-32 pb-4 sm:pb-6">
          <div className="container mx-auto px-4">
            <div className="max-w-2xl">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-2 sm:mb-4 text-white">
                Built to Solve Your Everyday Challenges
              </h2>
              <p className="text-base sm:text-lg text-white/70 text-opacity-90">
                No more guesswork — just real-time answers, built for modern Cannabis Data operations.
              </p>
            </div>
          </div>
        </div>
