  ...
  return (
    <ClientWrapper>
      <main className="min-h-screen bg-[#000A18]">
          ...
          <div className="absolute inset-0 flex py-24 sm:py-32 lg:py-48">
            <div className="container flex  mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
                  ...
                  >
                    <span className="relative z-10">a division of parad<span className='text-green-400'>Y</span>mdata.com</span>
                    <div className="absolute inset-0 shine-effect"></div>
                  </a>
                </div>
                <h1 className="text-left text-3xl leading-10 sm:text-3xl lg:text-4xl font-medium mb-3 sm:mb-4 text-white">
                Powered by Semantic AI: <br />Next-Level Insights for <br />  Cannabis Data Analytics
                </h1>
                <p className="text-left text-lg sm:text-sm lg:text-base text-opacity-50 text-white/60 mb-6 sm:mb-8">
                <BrandName variant="ai" /> uses Semantic AI—blending ML, NLP, <br /> and knowledge graphs—to turn raw distributor <br /> and POS data into actionable insights for growth and strategy.
                </p>
                <div className="flex flex-col  sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
                  <a 
                    href="/demo" 
                  ...
                  <a 
                    ...
                    className="w-full sm:w-auto text-center border border-white/60 px-4 sm:px-6 py-2.5 sm:py-3 rounded-md hover:bg-white hover:text-black transition-colors text-white text-base sm:text-base relative overflow-hidden"
                  >
        ...
        <section className="bg-[#000A18] min-h-screen relative py-12 sm:py-16 lg:py-24">
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              <div className="inline-block px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-green-500 text-white text-xs sm:text-sm mb-6 sm:mb-8 lg:mb-12">
              Unlock the Power of Semantic AI
              </div>
              <div className="flex justify-center">
                <AnimatedText 
                  text="Unlike traditional analytics tools that rely solely on pattern recognition, 420lytics.ai's Semantic AI understands the meaning, context, and intent behind your Cannabis Data's. It connects dots across retailers, SKUs, regions, and timeframes, transforming fragmented data into a clear, actionable picture of your business."
        ...
        <section id="solutions" className="bg-[#000A18] pt-12 sm:pt-16 lg:pt-32">
          <div className="container mx-auto px-4 sm:px-6 lg:px-16">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8">
              ...
              <div className="lg:col-span-5 lg:sticky lg:top-24 h-fit mb-6 sm:mb-8 lg:mb-32">
                ...
                Built for Cannabis Distributors. Trusted by Analysts
                </h2>
              ...
              <div className="lg:col-span-7 space-y-4 sm:space-y-6 lg:space-y-8 pb-12 sm:pb-16 lg:pb-32">
                {/* Card 1 */}
                <div className="bg-[#031322] border border-[#242E37]  rounded-xl sm:rounded-2xl lg:rounded-3xl p-4 sm:p-6 lg:p-12">
